...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post heroes_url, params: { hero: { name: @hero.name, poster_image: @hero.poster_image, slug: @hero.slug, title: @hero.title } }
  #   end
  #
  ...
  #   patch hero_url(@hero), params: { hero: { name: @hero.name, poster_image: @hero.poster_image, slug: @hero.slug, title: @hero.title } }
